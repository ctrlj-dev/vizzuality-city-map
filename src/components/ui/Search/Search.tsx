  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={cn(
          'w-full rounded-full pl-12 pr-4 py-3 border border-primary-200 text-primary-800 font-medium focus-visible:outline-none focus-within:ring-1 focus-within:ring-ring focus-within:ring-offset-2 focus-within:ring-primary-800 placeholder:text-primary-800 disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...props}
      />
